...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInput : MonoBehaviour
    {
        ...
        private void CheckInput()
        {
            ...
            (OVRInput.GetDown(OVRInput.Button.One, m_controller)))
            {
            ...
            (OVRInput.GetUp(OVRInput.Button.One, m_controller)))
            {
            ...
            if (Input.GetButtonDown("Cancel") || OVRInput.GetDown(OVRInput.Button.Two))
            {
                if (OnCancel != null)
                    OnCancel();
            }
