...
public class GDN_SceneLoader : MonoBehaviour {
    ...
    [SerializeField] private GDN_LoadScene LoadScene;                      // This calls functions within the teleportCamera script.
    ...
    private void RadialFilledComplete()
    {
        //Once the Radial fills.. Do this
         ...
         StartCoroutine (LoadScene.LoadNewScene());
