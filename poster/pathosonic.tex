...
PathoSonic is a VR experience where a participant interacts with sound visualization in space, performing analysis points and sequencing them in time. A screen capture with audio of a prototype for the performance can be seen on figure. Click here to watch the video: \href{https://www.youtube.com/watch?v=nnvPOeIh_fY}{https://www.youtube.com/watch?v=nnvPOeIh\_fY}

\begin{figure*}[htbp]
       \centering
              \includegraphics[width=0.75\textwidth]{screen-rec.png}
       \caption{A screen capture with audio of a prototype for the performance.}
       \label{fig:screen-rec}
\end{figure*}
